...
<div class="max-w-7xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800 border-l-4 border-green-500 pl-3">Project Saya</h1>
        <p class="text-gray-500 text-sm">Daftar project yang Anda kerjakan</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="col-span-full bg-white p-8 text-center rounded border border-gray-200">
            <p class="text-gray-500">Anda belum ditugaskan ke project manapun.</p>
        </div>
        @endforelse
    </div>
</div>
