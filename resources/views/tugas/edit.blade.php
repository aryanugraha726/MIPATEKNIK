        ...
        <form action="{{ route('tugas.update', $tugas->tugas_id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                    ...
                    <input type="date" name="start_tugas" value="{{ old('start_tugas', $tugas->start_tugas) }}" class="sync-start shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring focus:border-blue-300" required>
                </div>
                <div>
                    <label class="block text-gray-700 text-sm font-bold mb-2">Target Selesai</label>
                    <input type="date" name="target_tugas" value="{{ old('target_tugas', $tugas->target_tugas) }}" class="sync-target shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring focus:border-blue-300" required>
                </div>
                <div>
