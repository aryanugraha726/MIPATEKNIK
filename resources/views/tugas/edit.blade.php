        ...
        <form action="{{ route('tugas.update', $tugas->tugas_id) }}" method="POST">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="date" name="target_tugas" value="{{ old('target_tugas', $tugas->target_tugas) }}" class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring focus:border-blue-300" required>
                </div>
            </div>
