        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Telepon / HP</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ $v->cp_vendor ?: '-' }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ $v->phone_vendor ?: '-' }}</td>
                    <td class="px-6 py-4 text-sm text-gray-600">{{ $v->alamat_vendor ?: '-' }}</td>
                ...
                @empty
                <tr>
                    <td colspan="6" class="px-6 py-8 text-center text-gray-500 italic">Belum ada data vendor.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
