...
<div class="max-w-xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-2xl font-bold border-l-4 border-pink-600 pl-3">Edit Role #{{ $role->role_id }}</h1>
    ...
    <div class="bg-white rounded shadow-sm border border-gray-100 p-6">
        <form action="{{ route('role.update', $role->role_id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="nama_role" value="{{ old('nama_role', $role->nama_role) }}" class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring focus:border-indigo-300 uppercase" required>
            </div>
